...
public class StringSet {
    ...
    public static String text = "Carroll began writing the manuscript of the story the next day, although that earliest version is lost. " +
    ...
    public static Set<String> findUniqueWords() {
        String[] words = text.toLowerCase().replaceAll("[^a-zA-Z\\ss]", "").split("\\s+");
        System.out.println("Before TreeSet: " + words.length);
